...
build/test_unbounded.o: build/unbounded_int.o unbounded_int.h
	$(CC) $(CFLAGS) $(LDLIBS)  -c test_unbounded.c -o $@

build/unbounded_int.o: unbounded_int.c unbounded_int.h
	$(CC) $(CFLAGS) $(LDLIBS) -c unbounded_int.c -o $@

build/calc_unbounded_int.o: calc_unbounded_int.c unbounded_int.h
